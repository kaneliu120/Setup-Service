    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-6 py-8 max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-white border-gray-200">
            <CardHeader><CardTitle className="text-gray-900">Consultation Channels</CardTitle></CardHeader>
            <CardContent className="space-y-4">
              <p className="text-xs text-gray-500">Configure where the "Consult" button redirects users. Priority: Telegram Group → WhatsApp Group → WhatsApp DM → Built-in form.</p>
              <div>
                <Label className="text-gray-700">Telegram Group</Label>
                <Input value={form.content.telegram_group || ''} onChange={e => updateContent('telegram_group', e.target.value)} className="mt-1" placeholder="e.g. @kaneAIintelligence or https://t.me/kaneAIintelligence" />
                <p className="text-xs text-gray-400 mt-1">Public group handle or invite link. Highest priority.</p>
              </div>
              <div>
                <Label className="text-gray-700">WhatsApp Group</Label>
                <Input value={form.content.whatsapp_group || ''} onChange={e => updateContent('whatsapp_group', e.target.value)} className="mt-1" placeholder="e.g. https://chat.whatsapp.com/XXXXXXX" />
                <p className="text-xs text-gray-400 mt-1">Group invite link. Used if Telegram Group is not set.</p>
              </div>
              <div>
                <Label className="text-gray-700">WhatsApp Number (DM fallback)</Label>
                <Input value={form.content.whatsapp_number || ''} onChange={e => updateContent('whatsapp_number', e.target.value)} className="mt-1" placeholder="e.g. +639696352688" />
                <p className="text-xs text-gray-400 mt-1">Direct message fallback. Used if no group links are set.</p>
              </div>
            </CardContent>
          </Card>
