...
import { Boxes, Shield, Loader2, FileText, LogOut, CalendarCheck, Image, PenLine } from 'lucide-react';
          ...
          <Link href={`/${locale}/admin/portfolio`}>
            <Card className="bg-white border-gray-200 hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer group">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-gray-900 text-lg mb-1">Portfolio</h3>
                <p className="text-sm text-gray-500">Manage portfolio items and showcase projects</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href={`/${locale}/admin/blog`}>
            <Card className="bg-white border-gray-200 hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer group">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-gray-900 text-lg mb-1">Blog Posts</h3>
                <p className="text-sm text-gray-500">Write and publish blog posts for SEO</p>
              </CardContent>
            </Card>
          </Link>
        </div>
